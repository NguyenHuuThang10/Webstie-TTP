  ...
  <div class="hide991 header-pc">
    <div class="header-dc">
      <div class="wide-flex-left">
        Địa chỉ: 16/5 nguyễn Văn Bứa, Xuân Thới sơn, Hốc Môn, Thành Phố Hồ Chí Minh
      </div>
    ...
    <div class="header">
      <div class="header-top">
        <div class="logo">
          <img src="img/LOGO_TTP_2024-02.png" alt="logo-group-Tiến Thịnh Phát" title="logo-Tiến-Thịnh-Phát" width="100"
            height="auto">
        </div>
