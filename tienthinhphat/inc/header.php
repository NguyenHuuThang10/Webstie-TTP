...
<head>
  ...
  <base href="http://localhost/tienthinhphat-doantotnghiep-main/">
  ...
  <div class="hide991 header-pc">
    ...
    <div class="header">
      <div class="header-top">
        <div class="logo">
          <img src="img/LOGO_TTP_2024-02.png" alt="logo-group-Tiến Thịnh Phát" title="logo-Tiến-Thịnh-Phát" width="150"
            height="100">
        </div>
