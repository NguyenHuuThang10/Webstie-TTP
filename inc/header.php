...
<head>
  ...
  <base href="http://localhost:8484/well-known/">
...
<body>
  ...
  <div class="modal-popup" id="close-modal">
    <div class="cookie-popup">
      ...
      <a href="https://www.salanest.net/">
      <img src="img/sale5combo.png" alt="" width="400">
    </a>
    </div>
  </div>
  <?php } ?>
  <div class="hide991 header-pc">
    <div class="header-dc">
      <div class="wide-flex-left">
        Địa chỉ: 16/5 Nguyễn Văn Bứa, Xuân Thới Sơn, Hóc Môn, Thành Phố Hồ Chí Minh
      </div>
    ...
    <div class="header">
      <div class="header-top">
        <div class="logo">
          <img src="img/LOGO_TTP_2024-02.png" alt="logo-group-Tiến Thịnh Phát" href="./" title="logo-Tiến-Thịnh-Phát" width="150"
            height="100">
        </div>
        <div class="header-contact">
          <div class="header-contact-item">
            ...
            <div class="header-contact-item-login">
              <a href='profile.html'>
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#f48632" class="bi bi-person-circle"
            ...
            <div class="header-contact-item-login">
              <a title="Đăng xuất tài khoản" href="?customerid=<?php echo Session::get('customer_id')?>"
                ...
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width="18" height="18"
                  style="margin-right:5px" fill="#f48632">
                  <path
            ...
            <div class="header-contact-item-cart">
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#f48632" class="bi bi-basket3-fill"
                viewBox="0 0 16 16">
                <path
      ...
      <div class="header-bottom" id="header-bottom">
        <div class="logo-header-bottom" id="logo-header-bottom">
          <img src="img/LOGO_TTP_2024-04.png" alt="logo-group-Tiến Thịnh Phát" title="logo-Tiến-Thịnh-Phát" width="70"
            height="50">
        </div>
        <ul class="header-bottom-list">
                      ...
                      <div class="bottom-child">
                        <ul class="bottom-list-child">
                          ...
                          <li class="bottom-item-child">
                            <a
                              href="san-pham-theo-thuong-hieu/<?php echo isset($result_lv2['brand_id']) ?>/<?php echo isset($result_lv2['brand_id_lv2']) ?>-.html">
          ...
          <li class="header-bottom-item header-bottom-item-country">
            <a class="header-bottom-link" href="tintucsukien.html">
              BLOG & NEWS
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                class="bi bi-chevron-down" viewBox="0 0 16 16" style="margin-bottom:3px;">
                <path fill-rule="evenodd"
          ...
          <li class="header-bottom-item"><a class="header-bottom-link" href="tuyendung.html" title="Tuyển dụng">TUYỂN DỤNG</a></li>
  ...
  <div class="show991 sider-bar-tablet">
    ...
    <a href="./" class="logo"><img src="img/LOGO_TTP_2024-04.png" alt="anh-lo-go-tien-thinh-phat"></a>
